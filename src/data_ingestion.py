...
class DataIngestion:
    ...
    def download_csv_from_gcp(self):
        try:
            ...
            logger.error("Error while downloading CSV file from GCP")
            raise CustomException("Failed to download csv file", ce)
    ...
    def split_data(self):
        try:
            ...
            raise CustomException("Failed to split data", ce)
